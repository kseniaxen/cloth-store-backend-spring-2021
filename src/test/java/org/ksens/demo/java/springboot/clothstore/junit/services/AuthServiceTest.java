...
import org.ksens.demo.java.springboot.clothstore.services.AuthService;
import org.ksens.demo.java.springboot.clothstore.services.interfaces.IAuthService;
...
public class AuthServiceTest {
    ...
    @Test
    void givenAuthServiceMockWhenCallGetAllMethodThenReturnSuccessResponseModel () {
        // Обучаем макет:
    ...
    @Test
    void givenRoleModelWhenCallCreateMethodThenReturnSuccessResponseModel() {
    ...
    @Test
    void givenAuthServiceMockWhenCallGetRoleUsersMethodThenReturnSuccessResponseModel() {
    ...
    @Test
    void givenRoleIdWhenCallGetRoleUsersMethodThenReturnSuccessResponseModel() {
        // вызов метода getRoleUsers на макете с передачей ему аргумента 1
        ResponseModel responseModel =
